...
| 系统 | 文件 |
|---|---|
| Windows（安装版） | `img2cli_0.3.4_x64-setup.exe` / `img2cli_0.3.4_x64_en-US.msi` |
| Windows（免安装便携版） | `img2cli-v0.3.4-windows-portable.zip` |
| macOS（通用版） | `img2cli_0.3.4_universal.dmg` |
...
- **内置区域截图** —— 专用可配置热键（默认 `Alt+Shift+S`）打开拖拽选区覆盖层（Snipaste 风格），无需第三方截图工具。
