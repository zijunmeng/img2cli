...
* **Fixed Window Size** *(resolved in v0.3.12)*: The Settings window used to be locked at 800×600 (`"resizable": false`). It is now freely resizable with 720×520 minimum bounds.
